...
@Controller
public class GovernmentGrantsController {
    private QuestionService questionService;
    private QuestionRepository questionRepository;

    public GovernmentGrantsController(QuestionService questionService, QuestionRepository questionRepository) {
        this.questionService = questionService;
        this.questionRepository = questionRepository;
    }

    @GetMapping("/government-grants")
    public String governmentGrants(Model model) throws IOException {
        Question question = questionService.getQuestionById("government-grants");
        model.addAttribute("question", question);
        return "government-grants";
    }
    @PostMapping ("/government-grants")
